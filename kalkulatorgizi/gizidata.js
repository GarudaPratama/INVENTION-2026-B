const foodDatabase = [
  {
    ...
    expensive: { name: "Daging Sapi Lean (100g)", price: "~Rp 22.000", note: "Kalori: ~215 kcal | Protein: 26g" },
    cheap: { name: "Dada Ayam / Tempe (100g)", price: "~Rp 4.000", note: "Kalori: ~165 - 190 kcal | Protein: 19g - 25g" },
  ...
  },
  {
    ...
    category: "Protein Padat Gizi",
    subcategory: "Protein Utama",
    expensive: { name: "Daging Sapi Sirloin (100g)", price: "~Rp 35.000", note: "Kalori: ~244 kcal | Protein: 24g | Lemak: 16g" },
    cheap: { name: "Hati Ayam (100g)", price: "~Rp 4.000", note: "Kalori: ~167 kcal | Protein: 24g | Zat Besi: 11,6mg" },
  ...
  },  
  {
    ...
    expensive: { name: "Greek Yogurt Impor (200g)", price: "~Rp 30.000", note: "Kalori: 130 kcal | Protein: 15g" },
    cheap: { name: "Susu Full Cream Bubuk + 1 Pisang (1 Porsi)", price: "~Rp 6.000", note: "Kalori: 250 kcal | Protein: 8g" },
  ...
  },
  {
    ...
    expensive: { name: "Quinoa Impor (100g matang)", price: "~Rp 25.000", note: "Kalori: ~120 kcal | Serat: 7g | GI Rendah" },
    cheap: { name: "Ubi Jalar Rebus (100g)", price: "~Rp 3.000", note: "Kalori: ~86 kcal | Serat: 3g | Antioksidan Tinggi" },
  ...
  },
  {
    ...
    cheap: { name: "Nasi Kembang Kol / Ubi Kukus (100g)", price: "~Rp 4.000", note: "Kalori: ~25 - 90 kcal | Serat: 3g" },
  ...
  },
  {
    ...
    expensive: { name: "Ikan Salmon (100g)", price: "~Rp 35.000", note: "Kalori: ~206 kcal | Omega-3: 2,2g | Protein: 20g" },
    cheap: { name: "Ikan Kembung (100g)", price: "~Rp 8.000", note: "Kalori: ~167 kcal | Omega-3: 2,6g | Protein: 19g" },
  ...
  },
  {
    ...
    expensive: { name: "Artisan Granola Impor (1 Porsi)", price: "~Rp 25.000", note: "Kalori: ~230 kcal | Serat: 3g | Gula: 12g (Sirup/Madu)" },
    cheap: { name: "Oatmeal Biasa + Pisang + Wijen (1 Porsi)", price: "~Rp 4.000", note: "Kalori: ~240 kcal | Serat: 6g | Gula: 8g (Alami buah)" },
  ...
  },
  {
    ...
    expensive: { name: "Kombucha Botolan Aesthetic (300ml)", price: "~Rp 45.000", note: "Kalori: ~60 kcal | Gula: 10g | Probiotik: Ada" },
    cheap: { name: "Air Kelapa Muda Murni (300ml)", price: "~Rp 10.000", note: "Kalori: ~60 kcal | Gula: 6g (Alami) | Kalium/Elektrolit: Sangat Tinggi" },
